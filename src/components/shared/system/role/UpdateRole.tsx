...
const UpdateRole = ({ roleData, roleId }: UpdateRoleProp) => {
    ...
    const [featAX, setFeatAX] = useState(roleData?.featAX || false);
    const [featAY, setFeatAY] = useState(roleData?.featAY || false);
    const [featAZ, setFeatAZ] = useState(roleData?.featAZ || false);
    ...
    const [featBX, setFeatBX] = useState(roleData?.featBX || false);
    const [featBY, setFeatBY] = useState(roleData?.featBY || false);
    const [featBZ, setFeatBZ] = useState(roleData?.featBZ || false);
