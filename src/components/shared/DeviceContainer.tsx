        ...
        <>
            <div className="w-full h-screen bg-gray-200">
                ...
                <div className="flex ml-12 mr-64 mb-12">
                    <div className="w-[400px] z-20 ">
                        ...
                        <Listbox
                            ...
                            onChange={setActiveStatusSelect}
                        >
                            {({ open }) => (
                                <>
                                    <Listbox.Button
                                    ...
                                    >
                                        <Listbox.Options
                                            static
                                            className="absolute z-20 mt-1 w-full text-3xl bg-white border border-gray-300 rounded-xl shadow-lg max-h-60 overflow-auto focus:outline-none sm:text-sm"
                                        >
                    ...
                    <div className="w-[400px] ml-32 z-20">
                        <div className="text-3xl">Trạng thái kết nối</div>
                        <Listbox
                            value={connectStatusSelect}
                            onChange={setConnectStatusSelect}
                        >
                            {({ open }) => (
                                <>
                                    <Listbox.Button
                ...
                <div className="mx-12 z-0 text-start flex text-3xl font-light font-primary">
                    <table className="table-auto z-0 rounded-tl-2xl text-start drop-shadow-xl shadow-xl">
                        <thead>
                            <tr className=" rounded-tl-2xl h-24 font-bold bg-orange-500 text-white">
                                ...
                                <th className="border pl-6 pr-16 font-bold text-start">
                                    Địa chỉ IP
                                </th>
                                <th className="border px-6 font-bold text-start">
                        ...
                        <tbody>
                            <tr className="rounded-tl-2xl h-24 bg-white">
                                ...
                                <th className="border pl-6 pr-16 font-thin text-start ">
                                    192.168.1.10
                                </th>
                                <th className="border px-6 font-thin text-start ">
                                    Ngưng hoạt động
                                ...
                                <th className="border pl-6 w-[350px] font-thin text-start ">
                            ...
                            <tr className="rounded-tl-2xl h-24 bg-white">
                                ...
                                <th className="px-6 font-thin rounded-br-3xl text-start ">
                                    Cập nhật
                                </th>
                            </tr>{' '}
                        </tbody>
