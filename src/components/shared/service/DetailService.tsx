                                ...
                                <div className='w-full z-20'>
                                    ...
                                    >
                                        {({ open }) => (
                                            <>
                                                <Listbox.Button
                                                    className={`relative mt-4 rounded-xl w-[170px] bg-white border border-gray-300 shadow-sm pl-5 py-3 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-orange-200 focus:border-orange-200 sm:text-sm ${
                                                        activeOpen
                                                ...
                                                <div className='flex flex-col'>
                                                    <Listbox>
                                                        {({ open }) => (
                                                            <>
                                                                <Listbox.Button
                                                                    className={`relative mt-4 flex rounded-xl w-[145px] bg-white border border-gray-300 shadow-sm px-2 py-3 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-orange-100 focus:border-orange-100 sm:text-sm ${
